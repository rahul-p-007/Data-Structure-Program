...
//Using Sets
 ...
 int UnionAndIntersection(int arr1[],int arr2[],int size1,int size2){
    set<int> s;
    ...
    cout<<"The size of array is Union is : "<<s.size()<<endl;
    cout<<"The Union Element "<<endl;
...
int main()
{
    ...
    cout<<"\n";
    UnionAndIntersection(arr1,arr2,m,n);
    return 0;
}